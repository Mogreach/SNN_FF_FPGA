...
module neuron_core #(
    ...
    assign neuron_data_int = {NEUR_STATE[31:12], LIF_neuron_next_NEUR_STATE};//膜电位更新后的神经元状�?�信�??
    generate
        for (i=0; i<4; i=i+1) begin
            // 神经元状态信息更新：SPI 配置？（SPI指定地址？掩码后的编入数据：保持）：膜电位更�??
...
//    .ena   (CTRL_NEURMEM_CS       ),  // input ʹ���ź� 
//    .wea   (CTRL_NEURMEM_WE       ),  // input ��д�źţ�0����1д
